...
class YuelPocket(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.in_node_nf = const.N_RESIDUE_TYPES + const.N_ATOM_TYPES + 1 + 4 # +4 for masks (protein, joint, ligand, sas)
        self.in_node_nf = const.N_RESIDUE_TYPES + const.N_ATOM_TYPES + 1 + 4 # +4 for masks (protein, joint, ligand, sas)
        self.in_edge_nf = 1 + 1 + const.N_RDBOND_TYPES + 2 # +2 for edge masks (complex, probe)
