...
class YuelPocket(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        # Protein (N_ATOM_TYPES) + Ligand (N_ATOM_TYPES) + Masks (3)
        self.in_node_nf = const.N_ATOM_TYPES + const.N_ATOM_TYPES + 3
    ...
    def forward(self, g, training=False):
        ...
        # is_pocket/is_decoy/is_decoy2 mark the probes for contrastive learning
        ...
        for graph_mask_bool in g.get_batch_masks():
            ...
            if pos_mask.any() and decoy_mask.any() and decoy2_mask.any():
                ...
                # Success if pos_score is the highest among all probes in this tripartite comparison
